<div id="lightgallery" class="row grid" style="margin: 0 auto;">
    ...
    foreach ($data['images'] as $img) :
     ...
     ?>
    <!-- Category list -->
    <div class="col-sm-3 grid-item" data-responsive="<?php echo URLROOT . '/photoImg/mobile/' .  check_for_webp_version($img->gl_img); ?> 600" data-src="<?php echo URLROOT . '/photoImg/' . remove_white($img->gl_folder) . '/' .  check_for_webp_version(remove_white($img->gl_img)); ?>"
       ...
       <div class="category-block p-1 pt-2">
        <a href="#" data-toggle="tooltip" title="<?php echo $info; ?>"><span class="tooltip-qm"></span>
         <img class="lazyload" src="<?php echo URLROOT . '/photoImg/thumbs/' . check_for_webp_version($img->gl_img); ?>" data-original="<?php echo URLROOT . '/photoImg/' . remove_white($img->gl_folder) . '/' .  check_for_webp_version(remove_white($img->gl_img)); ?>" alt="<?php echo $info; ?>">
