        ...
        <div class="col-sm-4 grid-item">
            <div class="category-block p-1 pt-2 fitvids">
                <div class="category-list mb-3">
                    <iframe width="560" height="315" src="https://www.youtube.com/embed/<?php echo $vid->vd_embed; ?>?rel=0" frameborder="0" allow="accelerometer; encrypted-media; gyroscope; picture-in-picture" alt="<?php echo utf8_encode($vid->vd_title); ?>" allowfullscreen></iframe>
