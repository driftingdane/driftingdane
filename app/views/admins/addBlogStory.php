                ...
                <div class="row">
                    <div class="col-md-10 mx-auto">
                        <div class="card card-body bg-light mb-5">
                            ...
                            <form action="<?php echo URLROOT; ?>/admins/addBlogStory" class="icon-form process"
                                  enctype="multipart/form-data" method="post" novalidate>
                                <input type="hidden" name="token" value="<?php //echo createToken(); ?>">
                                <div class="col-md-12 mb-3">
                                    <label for="catId"><i class="far fa-flag formIcons"></i> Category:
                                        <sub>*</sub></label>
                                    <select id="catId" name="catId"
                                            class="custom-select custom-select-lg mb-3 <?php echo (!empty($data['cat_err'])) ? 'is-invalid' : ''; ?>"
                                            required>
                                ...
                                <?php
                                if (empty($data['postById']->ps_img)) {
                                    $setImg = "nologo.png";
                                } else {
                                    $setImg = $data['postById']->ps_img;
                                }
                                ?>
                                <div class="col-md-12 mb-3">
                                    <?php if (!empty($data['postById']->ps_img)) : ?>
                                        <label for="sameFile"><i class="fab fa-wordpress formIcons mt-3"></i> <span
                                                    class="inline-span">Feat. image: </span></label>
                                        <div class="userAvatar mt-3">
                                            <div class="custom-control custom-checkbox">
                                                <input id="removeLogo" class="custom-control-input" type="checkbox"
                                                       value="1" name="noImg">
                                                <label for="removeLogo" class="custom-control-label" for="customCheck">Remove
                                                    image</label>
                                            </div>
