                ...
                <div class="row">
                    <div class="col-md-10 mx-auto">
                        ...
                        <div class="card card-body bg-light mb-5">
                            ...
                            <form action="<?php echo URLROOT . '/admins/editStoryCategory/' . $data['catById']->ps_cat_id; ?>" class="icon-form process" enctype="multipart/form-data" method="post" novalidate>
                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <input id="glTitle" maxlength="100"
                                               ...
                                               name="glTitle"
                                               required
                                               type="text" value="<?php echo $data['catById']->ps_cat_name; ?>">
                                    ...
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <textarea id="glDesc" name="glDesc"
                                                  class="form-control form-control-lg profile_form_bio"><?php echo $data['catById']->ps_cat_desc; ?></textarea>
                                    </div>
