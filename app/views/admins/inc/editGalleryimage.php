<div class="card card-body bg-light mb-5">
    <?php
    if (empty($data['imageById']->gl_img)) {
        $setImg = "nologo.png";
    } else {
        $setImg = $data['imageById']->gl_img;
    }
    ?>
    ...
    <form action="<?php echo URLROOT . '/admins/uploadGalleryImg/' . $data['imageById']->gl_id; ?>"
        ...
        <input type="hidden" name="glFolder" value="<?php echo $data['imageById']->gl_folder; ?>">
                ...
                <?php if (!empty($data['imageById']->gl_id)) : ?>
                    ...
                    <div class="userAvatar mt-1">
                        <img class="img-fluid mx-auto d-block"
                             src="<?php echo URLROOT; ?>/photoImg/<?php echo remove_white($data['imageById']->gl_folder) . '/' . $setImg; ?>">
                    </div>
