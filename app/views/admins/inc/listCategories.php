                ...
                if(is_array($data['categories'])) :
                    foreach($data['categories'] as $gl_cat) : ?>
                        <tr class="smaller-font">
                            <th class=""><input type="checkbox" name="files[]" id="delete_image" class="checkbox" value="<?php echo $gl_cat->gl_cat_id; ?>"></th>
                            <th class="text-center text-md-left" scope="col"><?php echo $gl_cat->gl_cat_title; ?></th>
                            <th class="text-center text-md-left" scope="col"><?php echo $gl_cat->gl_cat_desc; ?></th>
                            <th class="text-center text-md-left" scope="col"><img width="130" class="lazyload" data-src="<?php echo URLROOT . '/catImg/' . $gl_cat->gl_cat_img; ?>" alt="<?php echo $gl_cat->gl_cat_img; ?>"></th>
