                ...
                if(is_array($data['categories'])) :
                    foreach($data['categories'] as $ps_cat) : ?>
                        <tr class="smaller-font">
                            <th class=""><input type="checkbox" name="files[]" id="delete_image" class="checkbox" value="<?php echo $ps_cat->ps_cat_id; ?>"><p class="hide_date small"><?php echo $ps_cat->ps_cat_id; ?></p></th>
                            <th class="text-center text-md-left w-20" scope="col"><?php echo $ps_cat->ps_cat_name; ?></th>
                            <th class="text-center text-md-left w-25" scope="col"><img class="img-fluid lazyload" data-src="<?php echo URLROOT . '/catImg/' . $ps_cat->ps_cat_img; ?>" alt="<?php echo $ps_cat->ps_cat_img; ?>"></th>
                            <th class="text-center text-md-left w-25" scope="col"><?php echo $ps_cat->ps_cat_desc; ?></th>
