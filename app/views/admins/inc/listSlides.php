<div class="col-md-9 col-sm-12 profileCard mb-5 table-responsive">
    ...
    <table class="table table-sm table-striped table-bordered reports">
        ...
        <tr>
            ...
            <th class="text-center w-25" scope="col">Image</th>
            ...
            foreach($data['slides'] as $sl) :
              if(!empty($sl->sl_data)) : $msg = "Has data"; else: $msg = ""; endif;
                ...
                <tr class="smaller-font">
                    <th class="text-center text-md-left w-20" scope="col"><?php echo $sl->sl_title; ?></th>
                    <th class="text-center text-md-left w-25" scope="col"><img class="img-fluid" src="<?php echo URLROOT . '/sliderImg/mobile/' . $sl->sl_img; ?>" alt="<?php echo $sl->sl_img; ?>"></th>
                    <th class="text-center text-md-left w-25" scope="col"><?php echo $sl->sl_desc; ?></th>
                    ...
                    <th class="text-center p-1" scope="col"><a href="<?php echo URLROOT . '/admins/editSlide/' . $sl->sl_id; ?>" class="btn btn-block btn-light btn-sm btn-block-xs"><i class="far fa-edit"></i></a>
                    <span class="small"><?php echo $sl->sl_id; ?></span>
