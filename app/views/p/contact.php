    ...
    <main role="main">
        ...
        <section class="mb-5">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-10 mx-auto"><?php echo flash('contact_message'); ?>
                            ...
                            <form class="icon-form" action="<?php echo URLROOT; ?>/p/contact" method="post">
                             <div class="form-row">
                                <div  class="col-md-6 mb-3">
                                    <label for="ctName"><i class="fas fa-signature formIcons color-orange-text"></i> <span class=""> Name: <sub>*</sub></span></label>
                                ...
                                <div class="col-md-6 mb-3">
                                    <label for="ctEmail"><i class="fas fa-at formIcons color-orange-text"></i> <span class=""> Email: <sub>*</sub></span></label>
                                ...
                                <div class="col-md-12 mb-3">
                                    <label for="ctMsg"><i class="far fa-comment-alt formIcons color-orange-text"></i> <span class="">
                                ...
                                <div class="form-control border-0">
                                    <button type="submit" value="Send" class="btn btn-primary mb-2 btn-block rounded"><i class="fas fa-sign-in-alt"></i> Send</button>
