                ...
                <div class="row">
                    <div class="col-md-6 mx-auto mt-5">
                        <div class="card card-body bg-light">
                            ...
                            <h4>Unsubscribe</span> from <span class="color-orange-text"><?php echo SITENAME; ?></span></h4>
                            <p>Please fill in all fields with <sub>*</sub></p>
                            <form class="form-group" action="<?php echo URLROOT; ?>/p/unsubscribe" method="post">
                                <div class="form-group">
                                    <label for="email"><i class="fas fa-at formIcons color-orange-text"></i> Email:
                                        <sub>*</sub></label>
                                ...
                                <div class="form-group">
                                    <label for="confirm_password"><i class="fas fa-at formIcons color-orange-text"></i> Confirm email:
                                        <sub>*</sub></label>
                                ...
                                <div class="row">
                                    <div class="col">
                                        <button type="submit" class="btn btn-outline-black"><i
                                                class="far fa-share-square fa-2x"></i> Unsubscribe
                                        </button>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col">
                                    <a href="<?php echo URLROOT; ?>" class="btn btn-outline-black">Stay and return home
                                    </a>
                                </div>
                            </div>
                        </div>
