    ...
    <main role="main">
        ...
        <section>
            <div class="container-fluid">
                <h1 class="text-center text-uppercase mt-3 mb-5"><i class="fas fa-wave-square color-orange-text fa-rotate-260"></i> Stories<span class="color-orange-text"></span> By Category <i class="fas fa-wave-square fa-rotate-45"></i></h1>
