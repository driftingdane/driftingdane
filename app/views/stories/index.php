                        ...
                        <div class="layout-blog__content">
                            <?php foreach ($data['posts'] as $post) : ?>
                                ...
                                <div class="post-01__style-02 md-text-center">
                                    <div class="post-01__media"><a
                                                href="<?php echo URLROOT . '/stories/show/' . $post->ps_slug . '/' . cleanerUrl($post->ps_title . ' ' . $post->ps_sub_title); ?>"><img
                                                    class="img-fluid"
                                                    src="<?php echo URLROOT . '/storyImg/feat/' . $post->ps_img; ?>"
                                                    alt="<?php echo $post->ps_img; ?>"></a>
                                    </div>
                                    <div>
                                        ...
                                        <h2 class="post-01__title"><a
                                                    href="<?php echo URLROOT . '/stories/show/' . $post->ps_slug . '/' . cleanerUrl($post->ps_title . ' ' . $post->ps_sub_title); ?>"><?php echo $post->ps_title . ' | ' . $post->ps_sub_title; ?></a>
                                        </h2>
