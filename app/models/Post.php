...
//// INSERT FUNCTIONS  /////////////////////////////////////////////////////////////////////////////
    ...
    public function savePost($data, $new_name)
    {
        ...
        $this->db->query('INSERT INTO pd_blog (ps_title, ps_sub_title, ps_entry, fk_cat_id, user_id, ps_img) 
                                      VALUES (:psTitle, :psSubTitle, :psPost, :catId, :userId, :post_img)');
        // Bind values
    ...
    public function getPosts()
    {
        ...
        $this->db->query('SELECT *,
                               ...
                               ORDER BY pd_blog.ps_created AND pd_blog.ps_id DESC');
    ...
    public function getPostsByCategory($id)
    {
        $this->db->query('SELECT *,
                               ...
                               LEFT JOIN users ON pd_blog.user_id = users.us_id
                               LEFT JOIN pd_blog_cat ON pd_blog_cat.ps_cat_id = pd_blog.fk_cat_id
                               WHERE :psCatId = ps_cat_slug ORDER BY pd_blog.ps_created ASC');

        // Bind values
        $this->db->bind(':psCatId', $id);
        $results = $this->db->resultSet();
        return $results;
    }
